              ...
              {activeTab === "whale" && (
                <Card className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button onClick={testWhalePredict} disabled={loading} className="w-full hover:scale-105 transition-transform duration-200 hover:shadow-lg hover:shadow-amber-500/50 disabled:hover:scale-100 disabled:hover:shadow-none">
              ...
              {activeTab === "sentiment" && (
                <Card className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button onClick={testSentiment} disabled={loading} className="w-full hover:scale-105 transition-transform duration-200 hover:shadow-lg hover:shadow-orange-500/50 disabled:hover:scale-100 disabled:hover:shadow-none">
                      <Play className="h-4 w-4 mr-2" />
                      {loading ? "Loading..." : "Run Test"}
                    </Button>
                  </CardContent>
