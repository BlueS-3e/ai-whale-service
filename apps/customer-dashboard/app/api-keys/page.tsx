      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <Button onClick={() => setShowNewKey(true)} className="hover:scale-105 transition-transform duration-200 hover:shadow-lg hover:shadow-amber-500/50">
          ...
          {showNewKey && (
            <Card className="mb-6 border-amber-200 dark:border-amber-800 bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl">
              <CardHeader>
