    ...
    <div className="min-h-screen relative">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-4 items-center">
            ...
            <Link href="http://localhost:3001/pricing" target="_blank" rel="noopener noreferrer">
              <Button className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 animate-pulse">Get API Access ✨</Button>
            </Link>
            <ThemeToggle />
          </nav>
          {/* Mobile menu button */}
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="p-6 pb-4 border-b border-amber-500/20 backdrop-blur-xl bg-gradient-to-r from-amber-600/5 to-orange-600/5">
                <div className="flex justify-between items-center">
                  <div>
                    <h3 className="font-bold text-xl bg-gradient-to-r from-amber-500 via-orange-500 to-yellow-500 bg-clip-text text-transparent">Menu</h3>
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-2">
                ...
                <Link href="http://localhost:3001/pricing" target="_blank" rel="noopener noreferrer" onClick={() => setMobileMenuOpen(false)}>
                  <Button className="w-full min-h-[56px] bg-gradient-to-r from-amber-500 via-orange-500 to-yellow-500 hover:from-amber-600 hover:via-orange-600 hover:to-yellow-600 text-white font-bold shadow-xl hover:shadow-2xl hover:shadow-amber-500/50 hover:scale-[1.02] transition-all duration-300 rounded-xl relative overflow-hidden group">
      ...
      <main className="container mx-auto px-4 py-8 md:py-12 relative z-10">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-amber-500 via-orange-500 to-yellow-500 bg-clip-text text-transparent">
            BNB Whale AI - Intelligence for the BNB Ecosystem
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center px-4">
            <Link href="/whale">
              <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-amber-500 via-orange-500 to-yellow-500 hover:from-amber-600 hover:via-orange-600 hover:to-yellow-600 text-white font-bold shadow-2xl hover:shadow-amber-500/50 hover:scale-105 transition-all duration-300">🚀 Try Live Demo</Button>
            </Link>
            <Button size="lg" variant="outline" className="w-full sm:w-auto border-2 border-amber-500 hover:bg-amber-500 hover:text-white font-semibold hover:scale-105 transition-all duration-300">📖 View API Docs</Button>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12 md:mb-16">
          <Card className="border-2 hover:border-amber-500 transition-all duration-300 bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl hover:shadow-2xl hover:shadow-amber-500/20">
            <CardHeader>
              <TrendingUp className="h-10 w-10 md:h-12 md:w-12 text-amber-500 mb-4" />
            ...
            <CardContent>
              ...
              <Link href="/whale">
                <Button className="w-full mt-4 min-h-[44px] bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-semibold shadow-lg hover:shadow-amber-500/50 hover:scale-105 transition-all duration-300">🐋 Try Whale Tracker →</Button>
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:border-orange-500 transition-all duration-300 bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl hover:shadow-2xl hover:shadow-orange-500/20">
            <CardHeader>
              <MessageSquare className="h-10 w-10 md:h-12 md:w-12 text-orange-500 mb-4" />
            ...
            <CardContent>
              ...
              <Link href="/sentiment">
                <Button className="w-full mt-4 min-h-[44px] bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 text-white font-semibold shadow-lg hover:shadow-orange-500/50 hover:scale-105 transition-all duration-300">💭 Try Sentiment Analyzer →</Button>
              </Link>
            </CardContent>
          </Card>
        ...
        <Card className="border-2 bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl">
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-amber-500/10 to-orange-500/10 rounded-lg">
      ...
      <footer className="border-t mt-16 py-8 bg-white/60 dark:bg-gray-900/60 backdrop-blur-md relative z-10">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>© 2026 BNB Whale AI • Powered by machine learning</p>
        </div>
      </footer>
    </div>
  );
